...
\begin{frame}[c]
    \centering
    \includegraphics[height=0.6\textheight]{images/Captura de tela de 2023-03-29 08-03-41.png}

    \begin{tcolorbox}[colback=red!20]
        Resposta em unidades do \textit{sistema imperial}:
        \begin{enumerate}[(a)]
            \item \(W=\SI{4.56}{Btu}\), \(Q=\SI{15.36}{Btu}\)
            \item \(W=\SI{4.35}{Btu}\), \(Q=\SI{15.36}{Btu}\)
        \end{enumerate}
    \end{tcolorbox}
\end{frame}
